...
4. **Exam Score Analysis Notebook (`exam score.ipynb`)**  
   - Analyzes students' **exam scores** based on features like study hours, sleep, attendance, and course type.  
   - Explores relationships between variables, e.g., higher sleep hours and higher exam scores.  
   - Builds and compares regression models:
     - Linear Regression
     - Ridge and Lasso Regression
     - Decision Tree
     - Random Forest  
   - Uses **Cross-Validation (CV R²)** and **GridSearch** for hyperparameter tuning.  
   - Visualizes results and extracts **key insights** from the models.  
